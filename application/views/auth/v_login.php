...
<head>
  ...
  <meta name="author" content="Cahyadi">
  ...
  <link href="<?= base_url('template/presento/') ?>assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="text-gray-900 mb-4">Silahkan Login terlebih dahulu</p>
                    <?php
                    if ($this->session->flashdata('logout') != '') {
                      echo '<div class="alert alert-success text-justify" role="alert">';
                  ...
                  <form class="user" action="<?= base_url('auth/proses') ?>" method="post">
                    ...
                    <a href="<?= base_url('') ?>" class="btn btn-success btn-user btn-block">
                      <i class="fas fa-home fa-fw"></i> Kembali Ke Beranda
                    </a>
                  </form>
                </div>
              </div>
